...
Add new categories to the sample data:
- "Research"
- "Training"
- "Integration"
- "Performance"
...
### **Custom Team Members**
Replace email addresses with your team's actual emails for realistic testing.

## 🚨 Important Notes

1. **Database State**: Scripts will add data to existing database. Clear data first if needed.
2. **Application Running**: Ensure the application is running before using API-based scripts.
3. **Development Only**: Sample data is designed for development/testing environments.
4. **H2 Console**: Available at http://localhost:8080/h2-console for direct database access.
5. **Data Persistence**: H2 in-memory database data is lost when application stops.
...
After running any script successfully, you should see:

- **25+ tasks** in various states
- **Task statistics** showing distribution
- **Realistic timeline** with overdue and upcoming tasks
- **Team workload** distribution
- **Category breakdown** for project management

Use the H2 console or API endpoints to verify the data was loaded correctly!
